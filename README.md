# 📔 DIARY WEB - Personal Diary Application

Aplikasi diary online yang bisa diakses dari mana saja oleh siapa saja!

---

## ⚡ QUICK START

### 1️⃣ LOCAL TESTING (Instant)
```bash
# Buka: d:\DIARY WEB\setup.html di browser
# Atau python -m http.server 8000
```

### 2️⃣ DEPLOY TO GITHUB PAGES (5 minutes)
See [DEPLOYMENT.md](DEPLOYMENT.md) for step-by-step.

### 3️⃣ SHARE WITH WORLD
```
...
- 📝 Create unlimited diary entries
- 🖼️ Upload 2 foto per entry (auto-compress)
...
| File | Purpose |
|------|---------|
| `setup.html` | Create/access diary |
| `diary-admin.html` | Admin panel |
| `diary-public.html` | Public view |
...
```
setup.html → Create diary → Admin panel → Share link → Public view
```
...
- **Default**: Browser localStorage (5-10MB)
- **Per diary**: Separate storage for each diary ID
...
- 🎯 **[QUICK-START.txt](QUICK-START.txt)** - Setup guide
- 🔧 **[REPAIRS.md](REPAIRS.md)** - Technical details
- 💯 **[TESTING_GUIDE.md](TESTING_GUIDE.md)** - Full testing
